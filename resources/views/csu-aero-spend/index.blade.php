                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('csu-aero-spend.create') }}" class="btn  btn-sm"
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <thead style="background-color: #E4E3E3 !important">
                                        <tr>
                                            <th>ID</th>
                                            <th>AMT KKB</th>
                                            <th>AMT KKB STATUS</th>
                                            <th>AMT CFS</th>
                                            <th>AMT CFS STATUS</th>
                                            {{-- <th>TYPE FEEDER</th> --}}
                                            <th>ACTION</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        @foreach ($datas as $data)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    {{ $data->amt_kkb}}</td>
                                                <td class="align-middle">{{ $data->amt_kkb_status }}</td>

                                                <td class="align-middle">{{ $data->amt_cfs }}</td>

                                                <td class="align-middle">{{ $data->amt_cfs_status }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myModal').on('show.bs.modal', function(event) {
                ...
                var modal = $(this);
                $('#remove-foam').attr('action', 'csu-aero-spend/' + id)
            });
