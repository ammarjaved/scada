...
<section class="content-header">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input disabled value="{{$data->special_tools_work}}" id="special_tools_work" class="form-control">

        </div>
    </div>
    <div class="text-center">
        <a href="{{route('site-data-collection.show',$data->site_data_id)}}"  class="btn btn-success mt-4"   style="cursor: pointer !important"
            type="submit">Goto Site Data</a>
    </div>
