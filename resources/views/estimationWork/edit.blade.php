...
<section class="content-header">
    ...
    <div class="row" id="rtu_color">
        ...
        <div class="col-md-4">
            <select name="rtu_cable_color" id="rtu_cable_color" class="form-control" onchange="addFeild(this)">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" name="rtu_size_cable" id="rtu_size_cable" class="form-control" value="{{$data->rtu_size_cable}}">
        </div>
    </div>
    ...
    <div class="row" id="rcb_color">
        ...
        <div class="col-md-4">
            <select name="rcb_cable_color" id="rcb_cable_color" class="form-control" onchange="addFeild(this)">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" name="rcb_size_cable" id="rcb_size_cable" value="{{$data->rcb_size_cable}}"  class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <select name="rcb_cable_length" id="rcb_cable_length" class="form-control">
                <option value="{{$data->rcb_cable_length}}" hidden>{{$data->rcb_cable_length}}</option>
            <option value="5">5m</option>
            <option value="10">10m</option>
            <option value="15">15m</option>
            <option value="20">20m</option>
    ...
    <div class="row" id="bc_color">
        ...
        <div class="col-md-4">
            <select name="bc_cable_color" id="bc_cable_color" class="form-control" onchange="addFeild(this)">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" name="bc_size_cable" id="bc_size_cable" value="{{$data->bc_size_cable}}" class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" name="efi_size_cable" id="efi_size_cable" value="{{$data->efi_size_cable}}" class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <select name="efi_cable_length" id="efi_cable_length" class="form-control">
                <option value="{{$data->efi_cable_length}}" hidden>{{$data->efi_cable_length}}</option>
            <option value="5">5m</option>
            <option value="10">10m</option>
            <option value="15">15m</option>
            <option value="20">20m</option>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <select name="switchgear_changes" id="switchgear_changes" class="form-control">
                <option value="{{$data->switchgear_changes}}" hidden>{{$data->switchgear_changes}}</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                <option value="other">other</option>
            </select>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <select name="cable_tracer_work" id="cable_tracer_work" class="form-control">
                <option value="{{$data->cable_tracer_work}}" hidden>{{$data->cable_tracer_work}}</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                <option value="other">other</option>
            </select>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" name="special_tools_work" value="{{$data->special_tools_work}}" id="special_tools_work" class="form-control">
