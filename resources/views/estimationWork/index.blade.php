              ...
              <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <a href="{{route('estimation-work.create')}}" class="btn  btn-sm" style="background-color: #367FA9; border-radius:0px; color:white">Add new</a>
                    </div>
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @foreach ($datas as $data)
                        <tr>
                            <td class="align-middle">{{ $data->siteData?  $data->siteData->nama_pe: '-'  }}</td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" href="{{ route('estimation-work.edit', $data->id) }}">Edit Foam</a>

                                    <a class="dropdown-item" href="{{ route('estimation-work.show', $data->id) }}">Detail</a>
