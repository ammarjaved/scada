              ...
              <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <a href="{{route('site-data-collection.create')}}" class="btn  btn-sm" style="background-color: #367FA9; border-radius:0px; color:white">Add new</a>
                    </div>
...
<span class="check" style="font-weight: 600; color: red;">&#x2715;</span>
                            ...
                            <td class="align-middle text-center"> @if ($data->count_during > 0)
                                <span class="check " style="font-weight: 600; color: green;">&#x2713;</span>
                                @else
                                <span class="check" style="font-weight: 600; color: red;">&#x2715;</span>
                                                                @endif</td>
                            <td class="align-middle text-center"> @if ($data->count_after > 0)
                                <span class="check " style="font-weight: 600; color: green;">&#x2713;</span>
                                @else
                                <span class="check" style="font-weight: 600; color: red;">&#x2715;</span>
                                                                @endif</td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" href="{{ route('site-data-collection.edit', $data->id) }}">Edit Foam</a>
                                    {{-- <a class="dropdown-item " href="{{ route('update-site-data-images.edit', $data->id) }}">Upload Images</a> --}}
                                    <button class="dropdown-item " data-id="{{$data->id}}" data-toggle="modal" data-target="#imagesModal">Upload Images</button>
                                    <a class="dropdown-item" href="{{ route('site-data-collection.show', $data->id) }}">Detail</a>

<button type="button" class="btn btn-primary dropdown-item"  data-id="{{$data->id}}" data-toggle="modal" data-target="#myModal">
    Remove
                                  </button>
                                  </div>
