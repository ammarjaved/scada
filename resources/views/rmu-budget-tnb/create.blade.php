    ...
    <div class="container bg-white  shadow my-4 " style="border-radius: 10px">
        ...
        <form action="{{ route('rmu-budget-tnb.store') }}" id="myForm" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                   <input type="text" name="pe_name" id="pe_name" class="form-control" value="{{$name}}" required  readonly>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="number" name="amt_kkb_pk" id="amt_kkb_pk" class="form-control" required>
                </div>
            </div>
