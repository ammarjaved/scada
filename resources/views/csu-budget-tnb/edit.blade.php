...
@section('content')
    ...
    <div class="container bg-white  shadow my-4 " style="border-radius: 10px">
        ...
        <form action="{{ route('csu-budget-tnb.update' , $data->id) }}" id="myForm" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input value="{{$data->kkb}}" type="number" name="kkb" id="kkb" class="form-control" required>
                </div>
            </div>
 ...
 <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input value="{{$data->date_time}}" type="datetime-local" name="date_time" id="date_time" class="form-control">
                </div>
            </div>
