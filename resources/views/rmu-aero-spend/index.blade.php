                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('rmu-aero-spend.create') }}" class="btn  btn-sm"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datas as $data)
                                            <tr>
                                                ...
                                                <td class="align-middle">{{ $data->amt_ir }}</td>

                                                <td class="align-middle">{{ $data->amt_ir_status }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myModal').on('show.bs.modal', function(event) {
                ...
                var modal = $(this);
                $('#remove-foam').attr('action', 'rmu-aero-spend/' + id)
            });
