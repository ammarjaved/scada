    ...
    <div class="container bg-white  shadow my-4 " style="border-radius: 10px">
        ...
        <form action="{{ route('rmu-aero-spend.update' ,$data->id) }}" id="myForm" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input value="{{$data->amt_ir_status}}" type="text" name="amt_ir_status" id="amt_ir_status" class="form-control" required>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input value="{{$data->amt_piw_status}}" type="text" name="amt_piw_status" id="amt_piw_status" class="form-control">
                </div>
            </div>
